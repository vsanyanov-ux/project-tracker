...
type SortField = 'title' | 'client' | 'deadline' | 'progress' | 'budget' | 'paid' | 'owed';
...
export const ProjectTableView: React.FC<ProjectTableViewProps> = ({ 
  ...
  const sortedProjects = [...projects].sort((a, b) => {
    ...
    if (sortField === 'title') {
      ...
      res = new Date(a.deadline).getTime() - new Date(b.deadline).getTime();
    } else if (sortField === 'progress') {
      res = calculateProjectProgress(a) - calculateProjectProgress(b);
    } else if (sortField === 'budget') {
      res = a.totalBudget - b.totalBudget;
                ...
                >
                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-2.5">
                      <span className={`w-2 h-2 rounded-full flex-shrink-0 ${priorityInfo.dotClass}`} />
                      <div>
