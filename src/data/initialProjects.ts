...
export const INITIAL_PROJECTS: Project[] = [
  {
    id: 'proj-yatv',
    title: 'Мультипликационный сериал «ЯТВ» (7 серий)',
    description: 'Психологический анимационный сериал про Зал Ожидания, встречу с фигурами родителей, юности и взрослой частью. Двухнедельный релизный цикл с 24 августа по 6 сентября.',
    client: 'Авторский проект / Канал ЯТВ',
    clientContact: '@yatv_official',
    ...
    milestones: [
      {
        id: 'ms-yatv-1',
        title: 'Этап 1: Производство серий 1–3 (Неделя 1)',
        progress: 67,
        dueDate: '2026-08-27',
        completed: false
      },
      {
        id: 'ms-yatv-2',
        title: 'Этап 2: Производство серий 4–6 (Неделя 2)',
        progress: 0,
        dueDate: '2026-09-03',
        completed: false
      },
      {
        id: 'ms-yatv-3',
        title: 'Этап 3: Производство финальной 7-й серии',
        progress: 0,
        dueDate: '2026-09-05',
        completed: false
      }
    ...
    tasks: [
      { id: 't-yatv-p1', title: '【Этап 1】 Серия 1 «Привокзальная площадь» (Ввод)', completed: true, dueDate: '2026-08-20' },
      { id: 't-yatv-p2', title: '【Этап 1】 Серия 2 «Предвкушение» (Фантазии о компенсации)', completed: true, dueDate: '2026-08-20' },
      { id: 't-yatv-p3', title: '【Этап 1】 Серия 3 «Не сейчас» (Сдать к показу 28.08)', completed: false, dueDate: '2026-08-27' },
      { id: 't-yatv-p4', title: '【Этап 2】 Серия 4 «Детство» (Фигуры родителей)', completed: false, dueDate: '2026-08-30' },
      { id: 't-yatv-p5', title: '【Этап 2】 Серия 5 «И никто не остановился» (Юность/взрослость)', completed: false, dueDate: '2026-09-01' },
      { id: 't-yatv-p6', title: '【Этап 2】 Серия 6 «Ты чего здесь сидишь?» («Никто не приедет»)', completed: false, dueDate: '2026-09-03' },
      { id: 't-yatv-p7', title: '【Этап 3】 Серия 7 «Выход из Зала Ожидания» (ФИНАЛ СЕРИАЛА)', completed: false, dueDate: '2026-09-05' }
    ],
    links: [],
    notes: '🗓 Календарь публикаций и анонсов:\n\nНеделя 1 (24–30 августа):\n• 24 авг (Пн): 🎬 Релиз Серии 1 «Привокзальная площадь» (Ввод)\n• 25 авг (Вт): 📃 Анонс киноразбора «Мулан»\n• 26 авг (Ср): 🎬 Релиз Серии 2 «Предвкушение»\n• 27 авг (Чт): 🟢 СВОБОДНЫЙ ДЕНЬ\n• 28 авг (Пт): 🎬 Релиз Серии 3 «Не сейчас»\n• 29 авг (Сб): 🟢 СВОБОДНЫЙ ДЕНЬ (напоминание о киноразборе)\n• 30 авг (Вс): ⚪️ ВЫХОДНОЙ (Отдых или легкий контент)\n\nНеделя 2 (31 августа – 6 сентября):\n• 31 авг (Пн): 🎬 Релиз Серии 4 «Детство» (Фигуры родителей)\n• 01 сен (Вт): 📃 Анонс (Киноразбор или план разборов на сентябрь)\n• 02 сен (Ср): 🎬 Релиз Серии 5 «И никто не остановился» (Фигуры юности/взрослости)\n• 03 сен (Чт): 🟢 СВОБОДНЫЙ ДЕНЬ\n• 04 сен (Пт): 🎬 Релиз Серии 6 «Ты чего здесь сидишь?» («Никто не приедет»)\n• 05 сен (Сб): 🟢 СВОБОДНЫЙ ДЕНЬ (Подводка к финалу)\n• 06 сен (Вс): 🎬 ФИНАЛ: Релиз Серии 7 «Выход из Зала Ожидания»\n\n⚡️ Текущий статус производства: 2 из 7 серий готовы (29% общего пайплайна)!',
  ...
  },
  {
    ...
    clientContact: '@futureskills_leads',
    category: 'Лендинг',
    status: 'in_review',
    priority: 'medium',
  ...
  },
  {
    ...
    clientContact: '@olga_potapova_biz',
